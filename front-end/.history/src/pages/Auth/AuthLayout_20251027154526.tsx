...
export function AuthLayout({ children, imageContent }: AuthLayoutProps) {
  return (
    <div className="flex items-center justify-center min-h-screen bg-beige-100">
      <div className="relative flex w-full max-w-6xl m-4 overflow-hidden bg-white rounded-2xl shadow-2xl">
        <Link
          to="/"
          className="absolute px-4 py-2 text-sm font-medium transition-colors rounded-lg top-4 left-4 text-beige-700 bg-beige-100 hover:bg-beige-200"
        >
          ← Back to Home
        </Link>
