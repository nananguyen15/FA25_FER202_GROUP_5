    ...
    const sampleOrders = [
      {
        ...
        items: [
          ...
          { id: "2", title: "To Kill a Mockingbird", quantity: 2, price: 12.99 },
        ],
        summary: {
          subtotal: 41.97,
          shipping: 5.00,
      ...
      },
      {
        ...
        status: "Preparing",
        items: [
          { id: "3", title: "1984", quantity: 1, price: 14.99 },
        ],
        summary: {
          subtotal: 14.99,
          shipping: 5.00,
    ...
    const sampleReviews = [
      {
        ...
        productType: "book",
        rating: 5,
        comment: "Absolutely loved this classic! The writing is beautiful and the story is timeless. Highly recommend to anyone who enjoys American literature.",
      ...
      },
      {
        ...
        productType: "book",
        rating: 5,
        comment: "One of the best books I've ever read. The themes of justice and morality are still relevant today. A must-read!",
      ...
      },
      {
        ...
        productType: "series",
        rating: 5,
        comment: "Magical! The entire series is a masterpiece. Worth every penny. My kids and I read it together and loved every moment.",
      ...
      },
      {
        ...
        productType: "book",
        rating: 4,
        comment: "Powerful and disturbing. Orwell's vision is chilling and thought-provoking. Took me a while to finish but definitely worth it.",
      ...
      },
      {
        ...
        productType: "book",
        rating: 5,
        comment: "Jane Austen at her finest. The romance, the wit, the social commentary - everything is perfect. Can't believe I waited so long to read this!",
      ...
      },
      {
        ...
        productType: "book",
        rating: 3,
        comment: "Interesting perspective on teenage angst, but I found Holden a bit too whiny at times. Good read overall though.",
  ...
  if (!existingPromotions) {
    ...
    const samplePromotions = [
      ...
      },
      {
        ...
        categoryId: null,
        categoryName: null,
        description: "Biggest sale of the year! $50 flat discount on all purchases.",
        discountType: "fixed",
        discountValue: 50,
