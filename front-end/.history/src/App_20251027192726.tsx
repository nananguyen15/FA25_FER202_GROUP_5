...
const initializeDefaultUsers = () => {
  ...
  if (!users.some((u: any) => u.username === "admin")) {
    users.push({ username: "admin", email: "admin@bookverse.com", password: "Vuivui123@", role: "admin" });
  }
  if (!users.some((u: any) => u.username === "staff")) {
    users.push({ username: "staff", email: "staff@bookverse.com", password: "Staff123@", role: "staff" });
  }
