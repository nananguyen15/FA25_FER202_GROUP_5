...
export function BaseCard({
  ...
  if (layout === "horizontal") {
    return (
      <a
        href={detailUrl || `#`}
        className="flex overflow-hidden transition-transform bg-white rounded-lg shadow-sm group hover:shadow-md hover:scale-102"
      >
        {/* Image - Left side */}
        ...
        <div className="flex flex-col justify-between w-1/2 p-4 bg-gradient-to-br from-gray-900 to-gray-800">
          ...
          <div className="flex items-center justify-between mt-auto">
            ...
            <button
              ...
              className="px-4 py-2 text-sm font-medium text-white transition-colors border border-white rounded hover:bg-white hover:text-gray-900"
              aria-label="Add to cart"
            >
              Add <BsCart2 className="inline w-4 h-4 ml-1" />
            </button>
          </div>
        </div>
      </a>
