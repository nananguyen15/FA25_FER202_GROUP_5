                  ...
                  >
                    {bookGroup.map((book, index) => {
                      ...
                      return (
                        ...
                        >
                          <Link to={bookLink} className="relative group">
                            <div className={`relative w-[180px] h-[300px] mx-auto mb-3`}>
                              <div
                              ...
                              <button
                                ...
                                className="absolute p-2 transition-all transform -translate-x-1/2 bg-white rounded-full shadow-lg opacity-0 bottom-4 left-1/2 group-hover:opacity-100 hover:scale-110 text-beige-700 hover:bg-beige-700 hover:text-white"
                                title="Add to cart"
                              >
                                <svg
                                  className="w-5 h-5"
