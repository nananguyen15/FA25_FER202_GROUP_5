  ...
  return (
    <div className="grid grid-cols-12 grid-rows-3 px-16 py-3">
      ...
      <div className="flex col-span-12 row-span-2 gap-4 flex-direction-row">
        ...
        <div className="col-span-2 row-span-1 bg-gray-200">Book 4</div>
        <div className="col-span-2 row-span-1 bg-gray-200">Book 5</div>
        <div className="col-span-2 row-span-1 bg-gray-200">Book 6</div>
      </div>
