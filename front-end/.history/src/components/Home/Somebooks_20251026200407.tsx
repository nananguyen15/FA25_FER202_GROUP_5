...
export function Somebooks() {
  // Try to get books from different possible exports
  const books = (bookData as any).books || 
                (bookData as any).heroBookGroups?.flat() || 
                (bookData as any).default || 
                [];

  // Debug: check what we're getting
  console.log("Book data module:", bookData);
