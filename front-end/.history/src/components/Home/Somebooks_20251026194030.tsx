export function Somebooks() {
  ...
  const card =
    "w-48 sm:w-56 md:w-64 h-44 sm:h-52 md:h-60 bg-gray-300 rounded-md flex items-center justify-center flex-shrink-0";
  ...
  return (
    <div className="grid grid-cols-12 px-16 py-6">
      ...
      */}
      <div className="flex flex-row items-start col-span-12 gap-5 flex-wrap justify-start">
