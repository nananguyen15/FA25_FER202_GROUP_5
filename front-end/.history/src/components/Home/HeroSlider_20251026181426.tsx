...
export default function HeroSlider({
  ...
  const scrollToSlide = (index: number) => {
    ...
    // update current slide immediately and set opacities so visuals change
    setCurrentSlide(index);
    setOpacities(booksData.map((_, i) => (i === index ? 1 : 0)));
  };
  ...
  <div className="mx-auto max-w-screen-2xl px-6 lg:px-24 py-6 lg:py-24">
        <div className="grid items-center grid-cols-1 gap-8 lg:grid-cols-12 ">
          ...
          <div className="lg:col-span-7">
            {/* center and constrain the slideshow area so lg column doesn't leave a big empty region */}
            <div className="flex items-center justify-center">
              <div className="flex items-center gap-4 w-full max-w-[920px] mx-auto">
                          ...
                          <div className="relative w-[180px] h-[300px] mx-auto mb-4">
                            <div
                              className={`w-full h-full overflow-hidden ${
                                isCenter ? "rounded-b-[100px]" : "rounded-t-[100px]"
                              }`}
                            >
                              <img
                                src={book.image ?? ""}
