export function Somebooks() {
  ...
  const card =
    "w-40 bg-gray-300 rounded-md animate-pulse flex items-center justify-center flex-shrink-0";

  return (
    <div className="grid grid-cols-12 grid-rows-3 px-16 py-6">
      {/* Title spans full width and has spacing */}
      <h2 className="col-span-12 row-span-1 mb-4 text-xl font-bold font-heading">
        Books
      </h2>

      {/* Cards container: fixed typos, allow wrap, align to start */}
      <div className="flex flex-row flex-wrap items-start col-span-12 row-span-2 gap-4">
