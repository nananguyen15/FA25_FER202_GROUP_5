export function Somebooks() {
  ...
  const card =
    "w-50 h-70 bg-gray-300 rounded-md flex items-center justify-center flex-shrink-0";
  ...
  return (
    <div className="grid grid-cols-12 px-16 py-6">
      ...
      <div className="flex flex-row items-start col-span-12 row-span-2 space-between grap-5 ">
