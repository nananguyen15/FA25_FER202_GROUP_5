...
export function BaseCard({
  ...
  if (layout === "horizontal") {
    return (
      <a
        href={detailUrl || `#`}
        className="flex h-64 overflow-hidden transition-transform bg-white rounded-lg shadow-md group hover:shadow-md hover:scale-102"
      >
        {/* Image - Left side */}
  ...
  return (
    <a
      href={detailUrl || `#`}
      className="block w-48 transition-shadow shrink-0 group sm:w-56 md:w-64 hover:shadow-2xs"
    >
      <div className="relative w-full h-64 mb-3 overflow-hidden rounded-lg sm:h-72 md:h-80">
        <img
          src={image}
          alt={title}
