  ...
  return (
      <div className="grid grid-cols-4 grid-rows-2 px-16 py-6">
        ...
        <div className="flex flex-row items-start justify-between col-span-4 gap-8 pb-4 overflow-x-auto">
          <div className="flex col-span-1 row-span-1">Book1 </div>
          <div className="col-span-1 row-span-1">Book2 </div>
          <div className="col-span-1 row-span-1">Book3 </div>
          <div className="col-span-1 row-span-1">Book4 </div>
        </div>
      </div>
  );
}
