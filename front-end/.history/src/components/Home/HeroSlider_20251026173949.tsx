        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 items-center gap-8 lg:min-h-[50vh]">
          ...
          <div className="lg:col-span-5">
            ...
            <a
              ...
              className="inline-flex items-center justify-center bg-beige-700 text-beige-100 px-6 py-3 font-medium tracking-wide transition-all duration-300 hover:bg-beige-800 active:translate-y-px"
            >
              Get Started
            </a>
          </div>
