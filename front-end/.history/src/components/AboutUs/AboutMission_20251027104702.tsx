      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-3">
          {missions.map((mission) => (
            <div key={mission.title} className="flex flex-col items-center p-6 transition-colors duration-300 border rounded-lg border-beige-300 hover:border-linear-color- border-beige-700">
