      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-3">
          {missions.map((mission) => (
            <div
              key={mission.title}
              className="relative p-1 bg-gradient-to-r from-beige-300 to-beige-700 rounded-lg hover:animate-pulse"
              style={{
            ...
            >
              <div className="flex flex-col items-center p-5 bg-[var(--color-lightest)] rounded-lg">
                ...
                <h3 className="mb-2 text-2xl font-semibold text-[var(--color-darkest)]">
                  {mission.title}
                </h3>
