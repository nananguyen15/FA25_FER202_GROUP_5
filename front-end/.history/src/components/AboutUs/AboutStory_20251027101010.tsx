        ...
        <div className="flex flex-col items-center gap-12 lg:flex-row lg:gap-20">
          ...
          >
            ...
            <h2 
              ...
              className="text-8xl md:text-9xl font-bold z-10 text-transparent bg-clip-text bg-linear-to-r from-[var(--book-tan)] to-[var(--book-brown-md)] transition-transform duration-100 ease-out"
            >
              2025
            </h2>
          </div>
