  ...
  return (
    <section className="px-16 py-24 bg-linear-to-t from-beige-500 to-beige-200 text-beige-100">
      <style>{`
        ...
        .mission-card {
          background: linear-gradient(90deg, rgb(175, 143, 111), rgb(116, 81, 45), rgb(84, 51, 16), rgb(116, 81, 45), rgb(175, 143, 111));
        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-3">
          {missions.map((mission) => (
            <div key={mission.title} className="relative p-1 rounded-lg mission-card">
              <div className="flex flex-col items-center p-5 bg-beige-50 rounded-lg">
