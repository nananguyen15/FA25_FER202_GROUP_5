    ...
    <section className="px-16 py-24">
      <div className="grid items-center grid-cols-1 gap-12 md:grid-cols-2">
        <div className="relative text-center">
          ...
          <h2 className="absolute font-bold -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 text-7xl md:text-8xl text-">
            2025
          </h2>
        </div>
        <div>
          <h3 className="mb-4 text-4xl font-bold font-heading text-">
            Our Story
          </h3>
