        ...
        <div className="flex flex-col items-center gap-12 lg:flex-row lg:gap-20">
          ...
          >
            ...
            <span
              ...
              className="absolute -top-12 left-0 text-[180px] font-black text-beige-300/10 opacity-60 select-none hidden lg:block transition-transform duration-100 ease-out"
            >
              2025
            </span>
            {/* (CẬP NHẬT) Thêm style và transition */}
