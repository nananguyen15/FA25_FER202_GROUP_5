export function AboutStory() {
  return (
    <section className="px-16 py-24 bg-linear-to-b from-amber-100 to-beige-200">
      <div className="grid items-center grid-cols-1 gap-12 md:grid-cols-2">
        ...
        <div>
          ...
          <p className="text-lg leading-relaxed text-beige-700">
            It all started in <strong>August 2025</strong> with a simple idea: to create a space
