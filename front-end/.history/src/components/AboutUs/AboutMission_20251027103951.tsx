  ...
  return (
    <section className="px-16 py-24 bg-linear-to-t from-beige-500 to-beige-200 text-beige-100">
      <div className="max-w-5xl mx-auto text-center">
        <h2 className="mb-4 text-6xl font-bold font-heading text-beige-200">Our Mission</h2>

        <blockquote className="relative py-4 pl-10 my-10 border-beige-100 order-beige mb-18">
        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-3">
          {missions.map((mission) => (
            <div key={mission.title} className="flex flex-col items-center p-6 border rounded-lg border-beige-300">
