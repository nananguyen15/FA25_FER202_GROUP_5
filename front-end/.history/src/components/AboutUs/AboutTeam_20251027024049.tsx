  ...
  return (
    <section className="px-16 py-24 bg-linear-to-b from-beige-500 to-beige-700">
      <div className="max-w-6xl mx-auto text-center">
        <h2 className="mb-4 text-4xl font-bold font-heading text-beige-900">
          Meet The Team
        </h2>
        <p className="mb-12 text-lg text-beige-700">
        ...
        <div className="grid grid-cols-2 gap-8 md:grid-cols-3 lg:grid-cols-5">
          {teamMembers.map((member) => (
            <div key={member.name} className="flex flex-col items-center">
              <div className="w-40 h-40 mb-4 overflow-hidden rounded-full bg-beige-700">
                <img
              ...
              <h3 className="font-semibold text-beige-00">
                {member.name}
              </h3>
