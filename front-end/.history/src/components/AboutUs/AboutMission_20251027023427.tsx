  ...
  return (
    <section className="px-16 py-24 bg-gradient-to-br from-[var(--color-darkest)] to-[var(--color-mid-dark)] text-[var(--color-lightest)]">
      <div className="max-w-5xl mx-auto text-center">
        ...
        <blockquote className="relative pl-12 border-l-4 border-[var(--book-tan)] my-10 py-4">
              <Feather className="absolute -top-2 left-0 w-8 h-8 text-[var(--book-tan)] opacity-60" />
              <p className="text-xl md:text-2xl font-serif italic text-[var(--book-cream)]">
                
              </p>
              <cite className="block text-right not-italic text-[var(--book-gray-light)]/70 mt-4">– Tục ngữ</cite>
            </blockquote>
