        ...
        <div className="flex flex-col items-center gap-12 lg:flex-row lg:gap-20">
          ...
          >
            ...
            <h2
              ...
              className="z-10 font-bold text-transparent transition-transform duration-100 ease-out text-8xl md:text-9xl bg-clip-text bg-linear-to-t from-beige-800 to-beige-500"
            >
              2025
            </h2>
          </div>
