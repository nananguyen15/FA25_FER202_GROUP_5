      ...
      <div className="flex gap-4">
        <div className="flex items-center gap-2">
          ...
          <div className="flex gap-2">
            <button className="flex items-center justify-center px-3 py-1 transition-colors border rounded-md background-transparent border-beige-700 text-beige-700 hover:bg-beige-700 hover:text-white">
              <a href="#" className="inline-block text-center w-full>Login</a>
            </button>
            <button className="flex items-center justify-center px-3 py-1 transition-colors border rounded-md background-transparent border-beige-700 text-beige-700 hover:bg-beige-700 hover:text-white">
              <a href="#" className="inline-block text-center w-full>Sign Up</a>
            </button>
          </div>
        </div>
      </div>
