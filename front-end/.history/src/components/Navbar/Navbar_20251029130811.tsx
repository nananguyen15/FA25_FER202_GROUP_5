...
export function Navbar() {
  ...
  const authStyle="px-4 py-2 text-sm font-semibold border rounded-md text-beige-700 border-beige-700 hover:bg-beige-700 hover:text-white whitespace-nowrap"
      ...
      <div className="flex items-center gap-5">
        ...
        {isAuthenticated ? (
          ...
          <div className="flex gap-3">
            ...
            <Link
              to="/signup"
              className="px-4 py-2 text-sm font-semibold border rounded-md text-beige-700 border-beige-700 hover:bg-beige-700 hover:text-white whitespace-nowrap"
            >
              Sign Up
            </Link>
          </div>
