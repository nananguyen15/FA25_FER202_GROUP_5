      ...
      <div className="flex gap-4">
        <div className="flex items-center gap-2">
          ...
          <div className="flex gap-2 ">
            <button className="px-3 py-1 transition-colors border rounded-md background-transparent border-beige-700 text-beige-700 hover:bg-sky-600 hover:text-white">
              <a href="#">Login</a>
            </button>
