    ...
    <nav className="flex flex-row items-center justify-between w-full px-10 py-3 bg-beige-50">
      ...
      {/* Right section: Search + Notifications + Cart + Auth*/}
          <div className="flex gap-2 ">
            <a
              href="#"
              className="inline-flex items-center justify-center px-3 py-1 leading-none transition-colors border rounded-md border-sky-600 text-sky-600 hover:bg-sky-600 hover:text-white"
            >
              Login
            </a>
            <a
