...
export function Navbar() {
  ...
  return (
    <nav className="flex flex-row items-center justify-between w-full px-10 py-3 bg-beige">
      {/* Brand text */}
      ...
      <div className="flex gap-4">
        <div className="flex items-center gap-2">
          <input type="text" placeholder="Search books..." className="w-64 px-2 py-1 transition-all border-b-2 border-transparent outline-none focus:border-blue-500 hover:border-blue-400" />
