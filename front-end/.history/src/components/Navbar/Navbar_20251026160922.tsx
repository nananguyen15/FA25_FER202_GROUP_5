...
<a
href="/login"
className="flex items-center justify-center px-3 py-1 text-center transition-colors bg-transparent border rounded-md w-28 border-beige-700 text-beige-700 hover:bg-beige-700 hover:text-white"
>
Login
</a>
