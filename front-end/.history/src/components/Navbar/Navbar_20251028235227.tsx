      ...
      <div className="flex items-center gap-5">
        ...
        {isAuthenticated ? (
          <>
            ...
            <Link to="/cart" className="relative text-beige-700 hover:text-beige-900">
          ...
          <div className="flex gap-3">
            <Link to="/signin" className="px-4 py-2 text-sm font-semibold text-beige-700 border rounded-md border-beige-700 hover:bg-beige-700 hover:text-white">
              Sign In
            </Link>
            <Link to="/signup" className="px-4 py-2 text-sm font-semibold text-beige-700 border rounded-md border-beige-700 hover:bg-beige-700 hover:text-white">
              Sign Up
            </Link>
          </div>
        )}
