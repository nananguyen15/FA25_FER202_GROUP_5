...
export default function SearchSuggest() {
  ...
  // Combine data for suggestions - MEMOIZED để tránh tạo mới mỗi lần render
  const allData = useMemo(
    ...
    [] // Empty dependency vì heroBookGroups và seriesData là static
  );
  ...
  useEffect(() => {
    ...
    return () => ac.abort();
  }, [debouncedQ, allData]); // Giờ allData đã được memoized nên an toàn
