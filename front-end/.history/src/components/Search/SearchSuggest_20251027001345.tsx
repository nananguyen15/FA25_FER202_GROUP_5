  ...
  return (
    <div className="relative w-full max-w-lg">
      <input
        ...
        className="w-64 px-2 py-1 transition-all border-b-2 border-transparent outline-none hover:border-beige-500"<IoMdSearch className="mr-3 w-7 h-7 text-beige-700" />
      />
      {loading && (
