  ...
  const faqData = [
    {
      ...
      answer:
        "Yes, you must have an account to add books to your cart and pur. However, creating an account allows you to track your orders, save your favorite books, and manage your personal information easily.",
    },
    {
