  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-beige-100">
      <div className="relative flex w-full max-w-6xl m-4 overflow-hidden bg-white shadow-2xl rounded-2xl">
        <Link
          to="/"
          className="absolute px-4 py-2 text-sm font-medium transition-colors rounded-lg top-12 left-4 text-beige-700 bg-beige-100 hover:bg-beige-200"
        >
          ← Back to Home
        </Link>

        {/* Form Section */}
        <div className="w-full p-8 lg:w-1/2 lg:h-[500px] lg:pt-20 flex flex-col justify-center">{children}</div>
