...
function Hero() {
  ...
  }, [currentSlide, booksData.length]); // depend on currentSlide to reset if changed

  if (loading) {
    return (
      <div style={{ backgroundColor: "#ede5dd", minHeight: "50vh", display: "flex", justifyContent: "center", alignItems: "center" }}>
        <p>Loading books...</p>
      </div>
    );
  }
