        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              ...
              <div>
                ...
                <input
                  ...
                  value={user?.username || ""}
                  disabled
                  className="w-full px-4 py-2 border rounded-lg bg-beige-50 border-beige-300 text-beige-600 cursor-not-allowed"
                />
              </div>
          ...
          <div className="flex justify-end pt-6 border-t border-beige-200">
            <button
              type="submit"
              disabled={isLoading}
              className="flex items-center gap-2 px-6 py-3 font-semibold text-white transition-colors rounded-lg bg-beige-700 hover:bg-beige-800 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <FaSave />
