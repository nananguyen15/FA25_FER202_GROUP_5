              ...
              paginatedPublishers.map((publisher) => (
                ...
                >
                  <td className="px-6 py-4 whitespace-nowrap">
                    <img
                      src={(publisher.image && publisher.image.trim() !== "") ? publisher.image : "/img/publisher/georgenewnes.webp"}
                      alt={publisher.name}
                      className="object-cover w-16 h-16 border-2 border-gray-200 rounded"
                      onError={(e) => {
                        console.warn("Failed to load publisher image:", publisher.image);
                        e.currentTarget.src = "/img/publisher/georgenewnes.webp";
                      }}
                    />
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
