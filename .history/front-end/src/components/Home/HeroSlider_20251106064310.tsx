...
export default function HeroSlider({
  ...
  useEffect(() => {
    ...
    console.log(`Auto-scroll to slide ${currentSlide}`, newOpacities); // Debug log
        ...
        <div className="grid items-center grid-cols-1 gap-8 lg:grid-cols-12">
          ...
          <div className="flex justify-end lg:col-span-7">
            <div className="flex items-center gap-2 w-fit">
              ...
              <div className="h-[480px] max-w-[680px] shrink-0 relative overflow-hidden">
                {booksData.map((bookGroup, groupIndex) => (
                  <motion.div
                    key={groupIndex}
                    className="flex justify-center gap-4 min-h-[470px] absolute inset-0"
                ...
                {/* Hidden scrollable container for controlling auto-scroll */}
                <div
                  ref={scrollContainerRef}
                  onScroll={handleScroll}
                  className="hide-scrollbar absolute inset-0 overflow-y-scroll opacity-0 pointer-events-none"
                  style={{ height: `${booksData.length * 500}px` }}
                >
