...
type SortOption = "all" | "newest" | "price-low" | "price-high" | "popular";
        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-9">
            <div className="p-6 bg-white rounded-lg shadow-sm">
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 justify-items-start">
