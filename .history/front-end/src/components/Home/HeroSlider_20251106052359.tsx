...
export default function HeroSlider({
  ...
  const handleScroll = (e: React.UIEvent<HTMLDivElement>) => {
    ...
    // Only show ONE slide at a time to prevent showing 5 images
    // When fraction < 0.5, show current slide; otherwise show next slide
    const activeIndex = fraction < 0.5 ? currentIndex : nextIndex;
              ...
              >
                {booksData.map((bookGroup, groupIndex) => (
                  <motion.div
                    ...
                    style={{
                      visibility: opacities[groupIndex] === 0 ? 'hidden' : 'visible',
                      pointerEvents: opacities[groupIndex] === 0 ? 'none' : 'auto',
                    }}
                  >
