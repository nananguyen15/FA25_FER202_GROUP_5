...
export function ForgotPassword() {
  ...
  const handleRequestOTP = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    try {
      // First, we need to check if email exists and get userId
      // For now, we'll send OTP directly (backend will handle if email doesn't exist)
  ...
  const handleVerifyOTP = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    try {
      // For forgot password flow, we need userId to verify OTP
      // Since we don't have userId from just email, backend needs to handle this
      // For now, we'll proceed to password step and handle verification there
      // TODO: Backend should provide an endpoint to verify OTP by email only
