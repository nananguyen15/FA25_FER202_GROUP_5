...
export function ForgotPassword() {
  ...
  const handleResendOTP = async () => {
    ...
    try {
      ...
      alert(`A new OTP has been sent to ${email}. The code will expire in 5 minutes.`);
            ...
            <div className="mb-6">
              ...
              {otpExpiryTime > 0 ? (
                <p className="mt-2 text-sm text-beige-600">
                  Code expires in: <span className="font-semibold text-orange-600">{formatTime(otpExpiryTime)}</span>
                </p>
              ) : (
