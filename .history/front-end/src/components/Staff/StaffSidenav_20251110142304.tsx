...
const staffNavLinks = [
  ...
  { to: "/staff/sup-categories", label: "Manage Parent Categories" },
  { to: "/staff/sub-categories", label: "Manage Sub Categories" },
    ...
    <div className="h-fit bg-white rounded-lg shadow-md sticky top-4">
      <div className="p-6 border-b border-beige-200">
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="font-semibold text-beige-900">{user?.name || "Staff"}</p>
