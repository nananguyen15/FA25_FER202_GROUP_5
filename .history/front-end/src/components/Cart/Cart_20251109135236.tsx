                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex items-center border rounded-md">
                          <button
                            ...
                            className="px-3 py-1 hover:bg-beige-100 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                          >
                            -
                          </button>
                          <input
                          ...
                          <button
                            ...
                            className="px-3 py-1 hover:bg-beige-100 transition-colors"
                          >
                            +
                          </button>
                        </div>
