                    ...
                    <div className="mb-4 space-y-3">
                      {cart?.cartItems
                        ...
                        .map((item) => (
                          ...
                          >
                            {/* Left: Quantity x Book title */}
                            <div className="flex items-start gap-2 flex-grow">
                              <span className="flex-shrink-0 text-beige-700">
                                {item.quantity}
                              </span>
                              <span className="flex-shrink-0 text-beige-600">
                                x
                              </span>
                            ...
                            {/* Right: Price */}
                            <span className="flex-shrink-0 font-semibold text-beige-900">
                              ${item.subtotal.toFixed(2)}
                            </span>
                          </div>
                        ))}
