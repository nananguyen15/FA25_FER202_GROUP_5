...
export function Cart() {
  ...
  useEffect(() => {
    ...
    const needsFetch = cart?.cartItems?.some(item => !bookDetails[item.bookId]);
    if (needsFetch) {
      fetchBookDetails();
    }
                  ...
                  >
                    ...
                    >
                      {loadingImages && !bookDetails[item.bookId] ? (
                        ...
                        <img
                          src={bookDetails[item.bookId]?.image?.replace('/src/assets', '') || "/img/book/placeholder.png"}
                          alt={item.bookTitle}
                          ...
                          onLoad={() => {
                            console.log("✅ Image loaded:", bookDetails[item.bookId]?.image);
                          }}
                        />
                      )}
                    </Link>
