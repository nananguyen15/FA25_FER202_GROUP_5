            ...
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                ...
                {cartItems.map((item) => (
                  ...
                  >
                    ...
                    <div className="flex-grow">
                      ...
                      {/* Quantity Controls at bottom - Left side */}
              ...
              <div className="p-6 bg-white rounded-lg shadow-sm lg:col-span-1 h-fit">
                ...
                {selectedItemsCount === 0 ? (
                  ...
                  <>
                    {/* List selected items in table format */}
                    <div className="mb-4 space-y-3">
                      {cart?.cartItems
                        ...
                        .map((item) => (
                          ...
                          >
                            {/* Quantity - 2 columns */}
                            <span className="col-span-2 text-beige-700">
                              {item.quantity}
                            </span>
                            {/* x symbol - 1 column */}
                            <span className="col-span-1 text-center text-beige-600">
                              x
                            </span>
                            {/* Book title - 6 columns */}
                            <span className="col-span-6 text-beige-700">
                              {item.bookTitle}
                            </span>
                            {/* Price - 3 columns */}
                            <span className="col-span-3 font-semibold text-right text-beige-900">
                              ${item.subtotal.toFixed(2)}
                            </span>
                          </div>
                        ))}
