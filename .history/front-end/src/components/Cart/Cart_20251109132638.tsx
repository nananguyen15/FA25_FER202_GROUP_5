...
const getBookImagePath = (bookId: number): string => {
  // Map bookId to image - this is temporary until backend provides image URL
  const imageMap: { [key: number]: string } = {
    ...
    6: "/img/book/hp6.webp",
    7: "/img/book/hp7.webp",
    8: "/img/book/got1.webp",
    9: "/img/book/got2.webp",
    10: "/img/book/got3.webp",
  };
  
  return imageMap[bookId] || "/img/book/placeholder.png";
};
              ...
              <div className="space-y-4 lg:col-span-2">
                ...
                <div className="flex items-center gap-3 p-3 bg-white rounded-lg shadow-sm">
                  <input
                    ...
                    className="w-5 h-5 text-beige-700 rounded cursor-pointer focus:ring-beige-500"
                  />
                ...
                {cartItems.map((item) => (
                  ...
                  >
                    ...
                    >
                      <img
                        src={getBookImagePath(item.bookId)}
                        alt={item.bookTitle}
                    ...
                    <div className="flex-grow">
                      ...
                      <div className="flex items-center gap-3 mt-3">
                        <span className="text-sm text-beige-600">Quantity:</span>
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className="px-3 py-1 border rounded hover:bg-beige-100 disabled:opacity-50 disabled:cursor-not-allowed"
                          >
                            -
                          </button>
                          <input
                            ...
                            className="w-16 px-2 py-1 text-center border rounded focus:outline-none focus:ring-2 focus:ring-beige-500"
                          />
                          <button
                            onClick={() =>
                              updateItemQuantity(item.bookId, item.quantity + 1)
                            }
                            className="px-3 py-1 border rounded hover:bg-beige-100"
                          >
                            +
                          </button>
                        </div>
