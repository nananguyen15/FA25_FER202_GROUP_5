    ...
    const fetchProduct = async () => {
      ...
      try {
        ...
        if (type === "book") {
          ...
          console.log("  - Book keys:", book ? Object.keys(book) : "null");
          console.log("✓ Authors count:", authorsData.length);
          console.log("  - First author:", authorsData[0]);
          console.log("✓ Publishers count:", publishersData.length);
          console.log("  - First publisher:", publishersData[0]);
          ...
          if (!bookWithNames) {
            throw new Error("Failed to map book data - mapBookWithNames returned null");
          }
