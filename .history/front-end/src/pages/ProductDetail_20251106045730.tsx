      ...
      <>
        ...
        <div className="flex items-center justify-center min-h-screen bg-beige-50">
          <div className="text-center">
            <div className="inline-block w-12 h-12 border-4 border-beige-300 border-t-beige-700 rounded-full animate-spin"></div>
      ...
      <>
        ...
        <div className="flex items-center justify-center min-h-screen bg-beige-50">
          <div className="text-center">
            ...
            <a href="/" className="mt-4 text-beige-600 hover:underline">Go back to home</a>
          </div>
        </div>
        <Footer />
      </>
