...
export const initAdminData = () => {
  console.log("Admin data initialization - TODO: Implement with API");
  // TODO: Fetch và initialize data từ backend API
...
export function initializeAdminData() {
  ...
  console.log("initializeAdminData: Skipped (using API instead of localStorage)");
  return;
