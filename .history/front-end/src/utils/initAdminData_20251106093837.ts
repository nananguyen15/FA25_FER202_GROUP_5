/**// Temporary stub - will be replaced with API integration

 * Admin Data Initialization

 * export const initAdminData = () => {

 * DEPRECATED: This file is no longer needed since we're using backend API.  console.log("Admin data initialization - Skipped (using backend API)");

 * All data (books, categories, authors, publishers, etc.) are fetched from the API.  // No longer needed - data is fetched from backend API
...
// DEPRECATED: No longer needed since we're using backend API

export const initAdminData = () => {export function initializeAdminData() {

  console.log("initAdminData - Skipped (using backend API)");  console.log("initializeAdminData - Skipped (using backend API)");

  return Promise.resolve();  // Categories and books are now fetched from the API
...
export function initializeAdminData() {
  ...
  console.log("initializeAdminData - Skipped (using backend API)");// DEPRECATED: No longer needed since we're using backend API

  return;export function updateCategoryBooksCount() {

}  console.log("updateCategoryBooksCount - Skipped (using backend API)");

  return;

export function updateCategoryBooksCount() {}

  console.log("updateCategoryBooksCount - Skipped (using backend API)");      // Add main category

  return;      flatCategories.push({
