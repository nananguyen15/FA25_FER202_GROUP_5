...
export const initAdminData = () => {
  console.log("Admin data initialization - Skipped (using backend API)");
  // No longer needed - data is fetched from backend API
  return Promise.resolve();
};

// DEPRECATED: No longer needed since we're using backend API
export function initializeAdminData() {
  console.log("initializeAdminData - Skipped (using backend API)");
  // Categories and books are now fetched from the API
  return;
}
