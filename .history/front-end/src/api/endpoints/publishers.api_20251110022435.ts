...
import type { ApiResponse, Publisher, PublisherCreateRequest, PublisherUpdateRequest } from "../../types";
...
export const publishersApi = {
  ...
  update: async (publisherId: number, data: PublisherUpdateRequest): Promise<Publisher> => {
