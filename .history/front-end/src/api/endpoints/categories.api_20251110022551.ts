...
export const categoriesApi = {
  ...
  sup: {
    ...
    update: async (supCategoryId: number, data: SupCategoryUpdateRequest): Promise<SupCategory> => {
  ...
  sub: {
    ...
    update: async (subCategoryId: number, data: SubCategoryUpdateRequest): Promise<SubCategory> => {
