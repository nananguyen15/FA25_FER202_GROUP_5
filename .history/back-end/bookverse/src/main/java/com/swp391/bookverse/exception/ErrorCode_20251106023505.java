...
public enum ErrorCode {
    ...
    // custom error codes for series entity
    SERIES_EXISTS(8001, "Series already exists"),
    SERIES_NOT_FOUND(8002, "Series not found"),
    NO_SERIES_STORED(8003, "No series stored in database"),
