...
## Setup Stepsn:
- Open Vsocde, `cd FA25_FER202_GROUP_5` and `cd front-end` folder
- **Install Frontend Dependencies**: Run the following command in your terminal to install the necessary packages (React, Tailwind, TypeScript) defined in package.json:
  ...
  npm i
  ```
- **Configure the Databas**e: To set up the database correctly, please follow the instructions in this video guide: [Database Setup Video](https://drive.google.com/file/d/1zzH_o-RQQtoanZhAhrFl6w6RQvO0tkWw/view?usp=sharing)
